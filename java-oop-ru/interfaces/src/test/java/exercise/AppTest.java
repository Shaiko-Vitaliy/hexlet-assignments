...
class AppTest {
    ...
    void testReversedSequence() {
        CharSequence text = new ReversedSequence("result");
        CharSequence text2 = new ReversedSequence("qwert");
        assertThat(text.toString()).isEqualTo("tluser");
        assertThat(text2.toString()).isEqualTo("trewq");
        assertThat(text.charAt(1)).isEqualTo('l');
        assertThat(text.length()).isEqualTo(6);
        assertThat(text.subSequence(0, 2).toString()).isEqualTo("tl");
    }
    // END
}
